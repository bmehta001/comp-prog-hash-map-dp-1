...
public class Question6_CoinAmounts {
    ...
    public static int solveRecursive(int n) {
        ...
        // Hint: Use a helper method explore(Set<Integer> amounts, int coinsLeft, int currentAmount)
        //       Base: always add currentAmount to the set
    ...
    public static int solveMemoized(int n) {
        ...
        // Hint: Use a boolean[][] visited or a Set<Long> where key = coinsLeft * (25*n+1) + amount
        return -1;
    }

    public static int solveIterative(int n) {
        // TODO: Implement bottom-up DP (iterative)
        // Use a boolean[] reachable of size 25*n+1
        // Start with reachable[0] = true
    ...
    public static void main(String[] args) {
        boolean passed = Question6_Tests.buildHarness(
                Question6_CoinAmounts::solveRecursive,
                Question6_CoinAmounts::solveMemoized,
                Question6_CoinAmounts::solveIterative)
