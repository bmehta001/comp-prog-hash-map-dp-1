 ...
 *  variables. No recursion, no extra storage -- just a simple loop.
 ...
 *
 *  Compile & run:
 *    g++ -std=c++17 -O2 question5_climb_stairs.cpp -o q5 && ./q5
 *    cl /std:c++17 /EHsc /O2 question5_climb_stairs.cpp /Fe:q5.exe && q5.exe
 * ===============================================================
 */
...
#include "question5_tests.h"

int main() {
    auto h = q5_tests::newHarness();
    bool passed = q5_tests::addTests(h, solveRecursive, solveMemoized, solveIterative)
